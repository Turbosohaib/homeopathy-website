                ...
                <div className="grid md:grid-cols-2 gap-12">
                    <div className="px-6 sm:px-0">
                        ...
                        <p className="mt-6 text-muted-foreground">
                            Schedule a consultation with Dr. Muhaa=mmad Zahid to discuss your health concerns and explore homeopathic
                            treatment options.
                        </p>
                        <div className="mt-8 space-y-4">
                            ...
                            <div className="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground">Hussain plaza Shell Oil Pump</p>
                                    <p className="text-muted-foreground">Hussain Abad Gulbahar</p>
                                    <p className="text-muted-foreground">Seena Ploy clinic Board Bus Stop</p>
