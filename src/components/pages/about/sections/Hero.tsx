...
export const Hero = () => {
    return (
        <section className="relative h-screen w-full">
            ...
            <div className="container mt-14 absolute inset-1/2 -translate-x-1/2 -translate-y-1/2 z-20 flex flex-col items-center justify-center text-center text-white">
