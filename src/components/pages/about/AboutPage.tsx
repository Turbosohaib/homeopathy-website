                            ...
                            <div className="grid md:grid-cols-2 gap-12 items-center">
                                <div className="z-10">
                                    ...
                                    <p className="mt-6 text-muted-foreground">
                                        At Dr. Muhammad Zahid Homeopathy, our mission is to provide
                                        the highest quality homeopathic care using scientific
                                        principles and evidence-based approaches. We are dedicated to
                                        treating the whole person, not just the symptoms, and to
                                        helping our patients achieve optimal health and wellness.
                                    </p>
                                    <p className="mt-4 text-muted-foreground">
                                        Our vision is to be a trusted provider of homeopathic
                                        medicine, recognized for our scientific approach, exceptional
                                        patient outcomes, and contributions to advancing the field of
                                        homeopathy through research and education.
                                    </p>
                                ...
                                <div className="md:col-span-2">
                                    <Tabs defaultValue="biography" className="w-full">
                                        ...
                                        >
                                            ...
                                            <p className="mb-4">
                                                Dr. Muhammad Zahid is a renowned homeopathic physician
                                                with over 20 years of experience in treating various
                                                chronic and acute conditions. He completed his Bachelor of
                                                Homeopathic Medicine and Surgery (BHMS) from a prestigious
                                                medical college and later earned his MD in Homeopathy,
                                                specializing in chronic disease management.
                                            </p>
                                            <p className="mb-4">
                                                After completing his education, Dr. Zahid worked at
                                                several leading homeopathic hospitals before establishing
                                                his own practice. His dedication to providing personalized
                                                care and his scientific approach to homeopathy has earned
                                            ...
                                            <p className="mb-4">
                                                Dr. Zahid believes in treating the whole person, not just
                                                the disease. His approach combines classical homeopathic
                                                principles with modern medical knowledge, ensuring that
                                                each patient receives comprehensive care tailored to their
                                                unique needs.
                                            </p>
                                            <p>
                                                &quot;Homeopathy is not just about treating symptoms;
                                                it&apos;s about understanding the root cause of illness
                                                and stimulating the body&apos;s natural healing
                                                mechanisms. When practiced with scientific rigor,
                                                homeopathy can offer effective solutions for many chronic
                                                conditions that conventional medicine struggles to address
                                                completely.&quot; - Dr. Zahid
                                            </p>
                                        </TabsContent>
                                        <TabsContent
                                            ...
                                            <ul className="space-y-4">
                                                <li className="flex items-start">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-muted-foreground">
                                                            Specialized treatment for arthritis, asthma,
                                                            allergies, and autoimmune disorders using advanced
                                                ...
                                                <li className="flex items-start">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-muted-foreground">
                                                            Treatment of skin disorders including eczema,
                                                            psoriasis, acne, and other persistent skin problems
                                                            with proven homeopathic remedies.
                                                        </p>
                                                    </div>
                                                </li>
                                                <li className="flex items-start">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-muted-foreground">
                                                            Comprehensive treatment for IBS, Crohn&apos;s
                                                ...
                                                <li className="flex items-start">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-muted-foreground">
                                                            ...
                                                            stress-related disorders, and other mental health
                                                            concerns.
                                                        </p>
                                                    </div>
                                                </li>
                                        ...
                                        >
                                            ...
                                            <p className="mb-6">
                                                ...
                                                focuses on establishing scientific evidence for
                                                homeopathic treatments and developing standardized
                                            ...
                                            <div className="space-y-6">
                                                <div className="border-l-4 border-[#0059B3] pl-4">
                                                    ...
                                                    <p className="mt-2">
                                                        A double-blind, placebo-controlled study demonstrating
                                                        the efficacy of individualized homeopathic treatment
                                                        in reducing pain and improving mobility in patients
                                                ...
                                                <div className="border-l-4 border-[#0059B3] pl-4">
                                                    ...
                                                    <p className="mt-2">
                                                        Research showing significant improvement in symptoms
                                                        and quality of life in patients with allergic rhinitis
                                                        treated with specific homeopathic protocols.
                                                    </p>
                                                </div>
                                                <div className="border-l-4 border-[#0059B3] pl-4">
                                                    <h4 className="font-bold">
                                                    ...
                                                    <p className="mt-2">
                                                        ...
                                                        treatments were successfully integrated with
                                                        conventional medical approaches, highlighting the
                                            ...
                                            <div className="mt-8">
                                                ...
                                                <p>
                                                    ...
                                                    efficacy of homeopathic treatments for autoimmune
                                                    disorders, with a focus on developing protocols that can
                                                    be integrated into mainstream healthcare.
                                                </p>
                                            </div>
                                        </TabsContent>
                                    </Tabs>
                        ...
                        <div className="container">
                            ...
                            <div className="grid md:grid-cols-3 gap-8">
                                <Card className="p-6 border-0 shadow-md">
                                    ...
                                    <p className="text-muted-foreground">
                                        Every patient receives a personalized treatment plan based on
                                        their unique symptoms, medical history, and constitution. Dr.
                                        Zahid takes the time to understand each patient&apos;s
                                ...
                                <Card className="p-6 border-0 shadow-md">
                                    ...
                                    <p className="text-muted-foreground">
                                        ...
                                        developments in homeopathy and integrative medicine to provide
                                ...
                                <Card className="p-6 border-0 shadow-md">
                                    ...
                                    <p className="text-muted-foreground">
                                        Dr. Zahid treats the whole person, not just isolated symptoms.
                                        His approach addresses physical, emotional, and mental aspects
                                        of health to promote complete healing and prevent recurrence
                                        of illness.
                                    </p>
                                </Card>
                            </div>
                                        ...
                                        <div className="p-6">
                                            <div className="flex items-start mb-4">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-muted-foreground">
                                                        Nouthia Jadeed, Peshawar Cantt, Pakistan
                                                    </p>
                                                </div>
                                            </div>
                                            <p className="mb-4">
                        ...
                        <div className="container">
                            <div className="grid md:grid-cols-2 gap-12 items-center">
                                <div>
                                    ...
                                    <p className="mt-6">
                                        Schedule a consultation with Dr. Muhammad Zahid to discuss
                                        your health concerns and explore personalized homeopathic
                                        treatment options.
                                    </p>
